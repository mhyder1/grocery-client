      ...
      <div className="add-list">
        <form className="add-list-form">
          ...
          <div className="add-list-section">
            ...
            <input type="text" name="name" className="add-name-input" value={this.state.name}/>
            <label className="list-label">Note:</label>
            <input className="add-note-input" type="text" name="note" value={this.state.note}/>
            <label className="list-label">Price:</label>
            <input className="add-price-input" type="text" name="price" value={this.state.price} />
            <label className="list-label">Weight:</label>
            <input className="add-Weight-input" type="text" name="weight" value={this.state.weight} />
