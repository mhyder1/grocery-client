      ...
      <div className="add-list">
        <form className="add-list-form" onSubmit={this.handleSubmit}>
          ...
          <div className="add-list-section">
            ...
            <input type="text" name="name" className="add-name-input" value={this.state.name} onChange={handleChange}/>
            <label className="list-label">Note:</label>
            <input className="add-note-input" type="text" name="note" value={this.state.note} onChange={handleChange}/>
            <label className="list-label">Price:</label>
            <input className="add-price-input" type="text" name="price" value={this.state.price} onChange={handleChange}/>
            <label className="list-label">Weight:</label>
            <input className="add-Weight-input" type="text" name="weight" value={this.state.weight} onChange={handleChange}/>
