...
class EditList extends React.Component {
    ...
    componentDidMount() {
        let list = this.context.lists.find(list => list.id === this.props.match.params.id)
        const {note, name, price, weight} = list
        console.log(list)
        this.setState({
            note,
            name,
    ...
    handleSubmit = (e) => {
        ...
        this.resetFields();
        this.context.updateList(newList, this.props.match.params.id);
    ...
    render() {
        ...
        return(
            <div className="edit-lists">
                <form onSubmit ={this.handleSubmit} clasName="edit-form">
                    <h2>Edit List</h2>
